...
bgen_wgs_22_qc="plink2 --bgen ukb24309_c22_b0_v1 \
	...
	--write-snplist --write-samples --no-id-header \
      	--out bgen_wgs_c22_qc_pass"

dx run swiss-army-knife -iin="${wgs_bgen_dir}/ukb24309_c22_b0_v1.bgen" \
	-iin="${wgs_bgen_dir}/ukb24309_c22_b0_v1.bgen.bgi" \
	-iin="${wgs_bgen_dir}/ukb24309_c22_b0_v1.sample" \
	-iin="${home_dir}/step1_qc/AFR_GWAS_cov.phe" \
     	-iin="${home_dir}/step1_qc/related_pairs.king.cutoff.out.id" \
     	-icmd="${bgen_wgs_22_qc}" --tag="bgen_qc_22" --instance-type "mem1_ssd1_v2_x36" --priority high \
