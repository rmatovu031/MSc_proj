...
c22_regenie_step2="regenie --step 2 --pgen ukb24308_c22_b0_v1 \
	--phenoFile AFR_GWAS_cov.phe --covarFile AFR_GWAS_cov.phe \
	--extract wgs_c22_qc_pass.snplist \
...
dx run regenie_test_associations \
	-iin="${wgs_plink2_dir}/ukb24308_c22_b0_v1.pgen" \
        ...
        -iin="${home_dir}/step2_qc/wgs_c22_qc_pass.snplist" \
	-iin="${home_dir}/step1_qc/regenie_step1_out_pred.list" \
	-iin="${home_dir}/step1_qc/regenie_step1_out_1.loco" \
        -icmd="${c22_regenie_step2}" --tag="c22_assoc" --instance-type "mem1_ssd1_v2_x36" --priority normal \
